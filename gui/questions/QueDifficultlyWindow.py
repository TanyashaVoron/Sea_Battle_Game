...
class DifficultlyWindow(object):
    def __init__(self):
        self.my_copy = NewCopy()
        self.my_copy.name_window = "DifficultlyWindow"

    def ui(self, window):
        if not window.objectName():
            window.setObjectName("DifficultlyWindow")
        ...
        self.my_copy.new_lable(self.que, 'сложность')
        ...
        self.button_dfficultly_easy = QPushButton(self.layout_widget)
        self.my_copy.new_button(self.button_dfficultly_easy, "легкая")
        self.vertical_layout.addWidget(self.button_dfficultly_easy)

        self.button_dfficultly_hard = QPushButton(self.layout_widget)
        self.my_copy.new_button(self.button_dfficultly_hard, "сложная")
        self.vertical_layout.addWidget(self.button_dfficultly_hard)
