...
class ShipsWindow(object):
    ...
    def ui(self, window):
        ...
        self.my_copy.new_lable(self.que, 'kорабли')
        ...
        self.my_copy.new_button(self.button_ships_angular, "прямые")
        self.vertical_layout.addWidget(self.button_ships_angular)

        self.button_ships_straight = QPushButton(self.layout_widget)
        self.my_copy.new_button(self.button_ships_straight, "угловые")
